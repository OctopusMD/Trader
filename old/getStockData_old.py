...
def csv_to_dataset(csv_path, young):
    ...
    # don't need the date of the stock data as long as it's sequenced
    ...
    for his in ohlcv_histories_normalized:
        ...
        # technical_indicators.append(numpy.array([sma,macd,]))
